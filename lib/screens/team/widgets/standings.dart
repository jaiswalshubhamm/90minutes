...
class _StandingsState extends State<Standings> {
  ...
  Widget build(BuildContext context) {
    ...
    List<standing.Response> _standing = teamData.standing.data?.response;
    if (teamData.standing.status != NetworkStatus.COMPLETED) {
      return Center(child: Loading());
    } else if (teamData.standing.status == NetworkStatus.COMPLETED) {
    ...
    } else if (teamData.standing.status == NetworkStatus.ERROR) {
      return Text("Error : ${teamData.standing.message}");
    } else {
      return Text("${teamData.standing.message}");
    }
  }
}
