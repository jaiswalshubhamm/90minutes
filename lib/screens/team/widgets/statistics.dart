                ...
                rows: <DataRow>[
                  DataRow(
                    cells: [
                      ...
                      DataCell(
                          Text('${statistics.fixtures.played.total ?? ''}'))
                    ],
                  ),
                  DataRow(
                    cells: [
                ...
                rows: <DataRow>[
                  DataRow(
                    cells: [
                      DataCell(Text('Total')),
                      DataCell(Text(
                          '${statistics.goals.goalsFor.total.total ?? ''}'))
                    ],
                  ),
                  DataRow(
                    cells: [
                ...
                rows: <DataRow>[
                  ...
                  DataRow(
                    cells: [
                      DataCell(Text('Home')),
                      DataCell(Text(
                          '${statistics.goals.goalsFor.average.home ?? ''}'))
                    ],
                  ),
                  DataRow(
                    cells: [
                      DataCell(Text('Away')),
                      DataCell(Text(
                          '${statistics.goals.goalsFor.average.away ?? ''}'))
                    ],
                  ),
                ],
              ),
                ...
                rows: <DataRow>[
                  DataRow(
                    cells: [
                      DataCell(Text('Home')),
                      DataCell(Text(
                          '${statistics.biggest.goals.goalsFor.home ?? ''}'))
                    ],
                  ),
                  DataRow(
                    cells: [
                      DataCell(Text('Away')),
                      DataCell(Text(
                          '${statistics.biggest.goals.goalsFor.away ?? ''}'))
                    ],
                  ),
                ],
              ),
